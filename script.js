document.addEventListener("DOMContentLoaded", function(e) {
    ...
    let profileDetail = document.querySelector("#profileDetail"); // 여기서 'profileDetail'을 '#profileDetail'로 수정
    let changing = false;
    ...
    profileEditButton.addEventListener("click", function(e) {
        if (changing) {
            ...
            if (_profileDetail.startsWith("http")) {
                _profileDetail = "<a href=\"" + _profileDetail + "\">" + _profileDetail + "</a>"; // 따옴표를 이스케이프하여 수정
            }
            ...
            userInfo.innerHTML = "<input value=\"" + _userInfo + "\"></input>"; // 따옴표를 이스케이프하여 수정
            summary.innerHTML = "<input value=\"" + _summary + "\"></input>"; // 따옴표를 이스케이프하여 수정
            profileDetail.innerHTML = "<input value=\"" + _profileDetail + "\"></input>"; // 따옴표를 이스케이프하여 수정
